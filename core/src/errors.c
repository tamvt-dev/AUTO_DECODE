...
const char* error_get_message(ErrorCode code) {
    switch (code) {
        ...
        case ERROR_INVALID_ENCODING: return "Invalid encoding";
        case ERROR_DECODE_FAILED: return "Decode failed";
        case ERROR_ENCODE_FAILED: return "Encode failed";
        case ERR_FILE_NOT_FOUND: return "File not found";
        case ERROR_FILE_READ: return "File read error";
        case ERROR_FILE_WRITE: return "File write error";
        case ERROR_OUT_OF_MEMORY: return "Out of memory";
        case ERROR_THREAD_CREATE: return "Thread create error";
        case ERR_TIMEOUT: return "Operation timeout";
        case ERR_CANCELLED: return "Cancelled by user";
        case ERROR_PLUGIN_LOAD: return "Plugin load error";
        case ERROR_PLUGIN_INIT: return "Plugin init error";
